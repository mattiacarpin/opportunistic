...
_wrap_PyNs3LbtsMessage__tp_init__2(PyNs3LbtsMessage *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    ...
    unsigned int id;
    bool isFinished;
    PyObject *py_isFinished;
    PyNs3Time *t;
    const char *keywords[] = {"rxc", "txc", "id", "isFinished", "t", NULL};
    
    if (!PyArg_ParseTupleAndKeywords(args, kwargs, (char *) "IIIOO!", (char **) keywords, &rxc, &txc, &id, &py_isFinished, &PyNs3Time_Type, &t)) {
        {
            PyObject *exc_type, *traceback;
            PyErr_Fetch(&exc_type, return_exception, &traceback);
            Py_XDECREF(exc_type);
    ...
    isFinished = (bool) PyObject_IsTrue(py_isFinished);
    self->obj = new ns3::LbtsMessage(rxc, txc, id, isFinished, *((PyNs3Time *) t)->obj);
    self->flags = PYBINDGEN_WRAPPER_FLAG_NONE;
    return 0;
}
...
PyObject *
_wrap_PyNs3LbtsMessage_IsFinished(PyNs3LbtsMessage *self)
{
    PyObject *py_retval;
    bool retval;
...
static PyMethodDef PyNs3LbtsMessage_methods[] = {
    {(char *) "IsFinished", (PyCFunction) _wrap_PyNs3LbtsMessage_IsFinished, METH_NOARGS, NULL },
...
_wrap_PyNs3MpiReceiver__tp_init__0(PyNs3MpiReceiver *self, PyObject *args, PyObject *kwargs, PyObject **return_exception)
{
    ...
    if (self->ob_type != &PyNs3MpiReceiver_Type)
    {
